...
export default function Courses() {
  ...
  // useMemo gives columns a stable reference so DataTable never re-renders
  // just because Courses re-renders. Without this, the inline .map() that
  // previously patched in handlers created a new columns array every render.
